					...
					<div class="navbar-collapse collapse">							
						<div class="menu">
							<ul class="nav nav-tabs" role="tablist">
			                    ...
			                    <li class="pull-right"><a href="logout">Logout | ${user.lname}</a></li>	
							</ul>
						</div>
					</div>						
				</div>
                    ...
                    <tbody  >
                     <c:forEach items="${users}" var="item">
                        <tr class="text-success">
                            ...
                            <th> 
                             <a title="Bio" href="bio?id=<c:out value='${item.id}'/>&lgid=<c:out value='${user.id}'/>"><c:out value="${item.fname}"/> <c:out value="${item.lname}"/></a> 														                                   
							</th>
							<th><c:out value="${item.subscription}"/></th>
							<th><c:out value="${item.selectClub}"/></th>

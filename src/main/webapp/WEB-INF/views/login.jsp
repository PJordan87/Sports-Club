...
<%java.text.DateFormat dft = new java.text.SimpleDateFormat("E yyyy.dd.MM 'at' hh:mm:ss a "); %>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
  ...
  <body>
	...
	<div class="container">
			...
			<div>
				<h1 style="color: #9A0D1A  ">Welcome to Sports Club</h1>
				<h3 style="color: #9A0D1A  ">${msg} </h3>
		...
		<div class="well">
			 <div class="row">
						...
						<form id="myForm" action="loginMember" method="post" class="bs-example form-horizontal">
							<fieldset>
								<legend class="text-center">Sports Club login </legend><br>								

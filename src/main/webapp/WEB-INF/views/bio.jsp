					...
					<div class="navbar-collapse collapse">							
						<div class="menu">
							<ul class="nav nav-tabs" role="tablist">								
								...
								<a href="#">${attribs.lname}'s Bio</a></li>
								<li><a class="btn btn-link" id="profilelink" onclick="document.forms['profile'].submit()">${user.lname} Profile</a>
					            </li>		
						        ...
						        <li class="pull-right"><a href="logout" id="logout">${user.lname} | Logout</a></li>
	...
	<input type="hidden" name="id" value="${attribs.id}">
		...
		<table class="table table-hover table-bordered" > 
						<tr style="background-color: #bce8f1;">
						     ...
						     <span class="fa fa-calendar" style="font-size:18px;color:red; padding-top: 2px;">
    		  ...
    		  <h3>My Bio</h3>
    		   ...
    		   <p>Visit my web site <a href="${attribs.website}">${attribs.website}</a></p>
    		  </div>
		</div>
		
		
		<div class="col-md-4">
		 <p class="text-info"> Hi ${user.lname} drop an Email to ${attribs.lname}</p>
		 </div>
		 <div class="row">		 
		<form id="msgArtist" method="post" action="messageArtist">			
			...
			<div class="col-md-4">
				<div class="form-group">
					...
					<input type="hidden" class="form-control"  id="name" name="name"  value="${user.lname}" placeholder="Name">
					
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
					<input type="hidden" class="form-control" id="subject" name="subject"  value="${user.emailAddress}" placeholder="Email">			    	
				</div>
			</div>

...
<html lang="en">
  ...
  <div class="container">	                                 
               ...
               <form  id="email-lookup" method="post"  action="email-lookup"> 
                     <div class="col-md-3">
    ...
    <div class="row">
       ...
       <form id="lookUpByLastnameOrFirstname" method="post"  action="lookUpByLastnameOrFirstname"> 
                     <div class="col-md-3" >
                           <div class="form-group">
			    ...
			    <form id="eLookupcityByZip" method="post"  action="LookupcityByZip">
                     <div class="col-md-3">
                         <div class="form-group">
                              <label for="emailAddressInput" >City Look-Up By Zip*</label>
